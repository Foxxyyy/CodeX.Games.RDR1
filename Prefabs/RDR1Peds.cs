...
namespace CodeX.Games.RDR1.Prefabs
{
    public class RDR1Peds
    {
        ...
        {
            Core.Engine.Console.Write("RDR1Peds", "Initialising Peds...");
            ...
            Core.Engine.Console.Write("RDR1Peds", "Building Prefabs...");
            ...
            Core.Engine.Console.Write("RDR1Peds", $"Peds initialised. Total time: {totaltime} ms");
        }
        ...
        public WftFile LoadWft(Rpf6FileEntry entry)
        {
            ...
            Core.Engine.Console.Write("RDR1Peds", entry.Name);
