...
namespace CodeX.Games.RDR1.Prefabs
{
    public class Vehicles
    {
        ...
        public void Init(Rpf6FileManager fman)
        {
            ...
            var vehicles = entries
                .Where(entry => entry.Value.Name.EndsWith(".vehsim"))
    ...
    public class RDR1VehiclePrefab : Prefab
    {
        ...
        public RDR1VehiclePrefab(Vehicles vehicles, string name)
        {
            Name = name;
            NameHash = new(name);
            Type = "Ped";
    ...
    public class RDR1Vehicle : Character, PrefabInstance
    {
        ...
        public RDR1Vehicle(RDR1VehiclePrefab prefab) : base(false)
        {
