...
namespace CodeX.Games.RDR1.RSC6
{
    ...
    public class Rsc6Texture : Rsc6TextureBase
    {
        ...
        public static TextureFormat GetTextureFormat(byte[] value)
        {
            ...
            return iFormat switch
            {
                ...
                0x32495441 => ConvertToEngineFormat(Rsc6TextureFormat.D3DFMT_ATI2), //1096042802
                ...
                0x1A => ConvertToEngineFormat(Rsc6TextureFormat.D3DFMT_A4R4G4B4),   //26
        ...
        public static byte[] ConvertTextureFormatToBytes(TextureFormat value)
        {
            int format = value switch
            {
                ...
                TextureFormat.A4R4G4B4 => 0x1A,  //A4R4G4B4
        ...
        public static TextureFormat ConvertToEngineFormat(Rsc6TextureFormat format)
        {
            return format switch
            {
                ...
                Rsc6TextureFormat.D3DFMT_ATI2 => TextureFormat.BC5,
                Rsc6TextureFormat.D3DFMT_A4R4G4B4 => TextureFormat.A4R4G4B4,
    ...
    public class Rsc6TextureCRN : Rsc6BlockBase
    {
        ...
        public override void Read(Rsc6DataReader reader)
        {
            ...
            var data = reader.ReadBytes((int)DataSize); //TODO: research crn format by D11
        }
