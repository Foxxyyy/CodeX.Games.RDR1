...
namespace CodeX.Games.RDR1.RSC6
{
    public class Rsc6Fragment : Rsc6BlockBaseMap, MetaNode //rage::fragType
    {
        ...
        public Rsc6Ptr<Rsc6AssociationGroup> AssociatedFragments { get; set; } //m_AssociatedFragments
        ...
        public override void Read(Rsc6DataReader reader)
        {
            ...
            AssociatedFragments = reader.ReadPtr<Rsc6AssociationGroup>();
        ...
        public override void Write(Rsc6DataWriter writer)
        {
            ...
            writer.WritePtr(AssociatedFragments);
        ...
        public void Write(MetaNodeWriter writer)
        {
            ...
            writer.WriteNode("AssociatedFragments", AssociatedFragments.Item);
    ...
    public class Rsc6FragmentDrawable : Rsc6Drawable //rage::fragDrawable
    {
        /*
    ...
    public class Rsc6AssociationInfo : Rsc6BlockBase, MetaNode //AssociationInfo
    {
    ...
    public class Rsc6AssociationGroup : Rsc6BlockBase, MetaNode //AssociationGroup
    {
        public override ulong BlockLength => 8;
        public Rsc6ManagedArr<Rsc6AssociationInfo> Associations { get; set; } //m_Associations

        public override void Read(Rsc6DataReader reader)
        {
            Associations = reader.ReadArr<Rsc6AssociationInfo>();
        }

        public override void Write(Rsc6DataWriter writer)
        {
            writer.WriteArr(Associations);
        }

        public void Read(MetaNodeReader reader)
        {
            Associations = new(reader.ReadNodeArray<Rsc6AssociationInfo>("Associations"));
        }

        public void Write(MetaNodeWriter writer)
        {
            writer.WriteNodeArray("Associations", Associations.Items);
        }
    }
